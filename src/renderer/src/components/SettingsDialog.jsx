...
import { HiOutlineChevronDown, HiOutlineChevronUp, HiOutlineCog6Tooth } from 'react-icons/hi2'
...
export default function SettingsDialog() {
  ...
  const pickExtensionPath = useCallback(async () => {
    const result = await window.electron.ipcRenderer.invoke('pick-extension-path', extensionPath)
  ...
  return (
    <Dialog.Portal>
      ...
      >
        <HiOutlineCog6Tooth className="size-10 mx-auto text-blue-500" />
        <div>
        ...
        {/* Extension Path */}
        <label className="text-neutral-400">Extension Path</label>
        <div className="flex gap-2">
